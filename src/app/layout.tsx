...
export default function RootLayout({
  ...
  return (
    <html lang="en">
      ...
      <body
        className={`${inter.variable} ${playfair.variable} ${spaceGrotesk.variable} ${jetbrainsMono.variable} antialiased bg-background-light dark:bg-background-dark text-gray-800 dark:text-gray-200`}
      >
        {children}
      </body>
    </html>
